...
export default function Footer() {
    return (
        <footer className="bg-slate-100 mt-5 pt-5">
            <div className="max-w-[1000px] mx-auto p-3 grid grid-cols-4 gap-3 mb-5">
                <div>
                    <h1 className="mb-3 font-bold text-slate-800">
                        Useful Link
                    </h1>
                    <p>Find Property</p>
                    <p>Sell Property</p>
                ...
                <div>
                    <h1 className="mb-3 font-bold text-slate-800">About</h1>
                    <p>About Us</p>
                    <p>How it Works</p>
                    <p>Contact Us</p>
                    <p>Blog</p>
                ...
                <div>
                    <h1 className="mb-3 font-bold text-slate-800">Terms</h1>
                    <p>Provacy Policy</p>
                ...
                <div>
                    ...
                    <div>
                        <p>Jl. Letkol Subroto</p>
                        <p>Triharjo, SLeman</p>
                        <p>Yogyakarta</p>
                    </div>
                </div>
            </div>
            <div className="text-center bg-teal-600 text-white p-5">
                <div>Icon Sosmed</div>
                <p>Copyright 2023 Real estate, inc.</p>
            </div>
        </footer>
    );
}
